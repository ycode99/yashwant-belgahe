...
import { GalleryVerticalEnd, Signature } from "lucide-react";

const Figma = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 384 512" fill="currentColor" className={props.className}>
    <path d="M96 0C43 0 0 43 0 96s43 96 96 96h96V96c0-53-43-96-96-96zm0 320c-53 0-96 43-96 96s43 96 96 96h96v-96c0-53-43-96-96-96zm96-128c0-53-43-96-96-96S0 139 0 192s43 96 96 96h96v-96zm96-96c-53 0-96 43-96 96v96h96c53 0 96-43 96-96s-43-96-96-96zm-96 224v96c0 53 43 96 96 96s96-43 96-96v-96H192z" />
  </svg>
);
...
interface Hero213Props extends HeroCutoutGalleryProps {}
type Props = Partial<Hero213Props>;

const defaultProps: Hero213Props = {
...
const Hero213 = (props: Props) => {
  const { heading, description, images, className } = {
    ...defaultProps,
    ...props,
  };
